...
import (
	...
	"github.com/FoBoHuang/tinyblog/internal/apiserver/biz"
	"github.com/FoBoHuang/tinyblog/internal/apiserver/model"
	"github.com/FoBoHuang/tinyblog/internal/apiserver/pkg/validation"
	"github.com/FoBoHuang/tinyblog/internal/apiserver/store"
	"github.com/FoBoHuang/tinyblog/internal/pkg/contextx"
	"github.com/FoBoHuang/tinyblog/internal/pkg/known"
	"github.com/FoBoHuang/tinyblog/internal/pkg/log"
	mw "github.com/FoBoHuang/tinyblog/internal/pkg/middleware/gin"
	"github.com/FoBoHuang/tinyblog/internal/pkg/server"
)
...
func (cfg *Config) NewDB() (*gorm.DB, error) {
	...
	casbinRules := []model.CasbinRuleM{
		...
		{PType: ptr.To("p"), V0: &userR, V1: ptr.To("/v1.TinyBlog/DeleteUser"), V2: ptr.To("CALL"), V3: ptr.To("deny")},
		{PType: ptr.To("p"), V0: &userR, V1: ptr.To("/v1.TinyBlog/ListUser"), V2: ptr.To("CALL"), V3: ptr.To("deny")},
