...
//go:generate mockgen -destination mock_store.go -package store github.com/FoBoHuang/tinyblog/internal/apiserver/store IStore,UserStore,PostStore,ConcretePostStore
