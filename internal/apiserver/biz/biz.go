...
//go:generate mockgen -destination mock_biz.go -package biz github.com/FoBoHuang/tinyblog/internal/apiserver/biz IBiz

import (
	"github.com/google/wire"
	"github.com/onexstack/onexstack/pkg/authz"

	postv1 "github.com/FoBoHuang/tinyblog/internal/apiserver/biz/v1/post"
	userv1 "github.com/FoBoHuang/tinyblog/internal/apiserver/biz/v1/user"

	// Post V2 版本（未实现，仅展示用）
	// postv2 "github.com/FoBoHuang/tinyblog/internal/apiserver/biz/v2/post".
