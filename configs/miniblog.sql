...
--
-- Host: 10.37.91.93    Database: tinyblog
-- ------------------------------------------------------
...
--
-- Current Database: `tinyblog`
--

/*!40000 DROP DATABASE IF EXISTS `tinyblog`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `tinyblog` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
...
(7,'p','role::user','/v1.TinyBlog/DeleteUser','CALL','deny','',''),
(8,'p','role::user','/v1.TinyBlog/ListUser','CALL','deny','',''),
