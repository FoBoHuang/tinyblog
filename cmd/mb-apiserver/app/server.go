...
import (
	...
	"github.com/FoBoHuang/tinyblog/cmd/mb-apiserver/app/options"
	"github.com/FoBoHuang/tinyblog/internal/pkg/log"
)

var configFile string // 配置文件路径

// NewTinyBlogCommand 创建一个 *cobra.Command 对象，用于启动应用程序.
...
• High-quality code.`,
		...
		// 设置命令运行时的参数检查，不需要指定命令行参数。例如：./tinyblog param1 param2
		Args: cobra.NoArgs,
	}
	...
	cmd.PersistentFlags().StringVarP(&configFile, "config", "c", filePath(), "Path to the tinyblog configuration file.")
